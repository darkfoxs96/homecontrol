...
export class SoundParsingService {
  ...
  */
  ...
  getSoundParsing(sound_parsing_id: string): Observable<StatusInterfaceServer> {
    return this.httpClient.get<StatusInterfaceServer>('/api/soundparsing/' + sound_parsing_id);
  }
}
