...
type ControlSystemHome interface {
	...
	GetListCommandJSON() (json string, err error)
...
// GetListCommandJSON return {["commandID", "info command"], ["commandID", "info command"], ["", ""]...}
func GetListCommandJSON() (json string, err error) {
	return
}
