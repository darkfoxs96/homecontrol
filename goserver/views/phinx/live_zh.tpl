...
<body>
    ...
    <script>
            ...
            spawnWorker("static/js/recognizer.js", function(worker) {
                ...
                worker.onmessage = function(e) {
                    ...
                    if (e.data.hasOwnProperty('hyp')) {
                        ...
                        var newHypChinese = e.data.hyp.split(' ').map(function(x) {
                            return wordListChinese[x];
                        }).join(' ');
        ...
        var wordList = [
            ["ni_hao", "n i h ao"],
            ["ni_hao_ma", "n i h ao m a"],
            ["zai_jian", "z ai j ian"],
            ["huan_ying", "h uan y ing"],
            ["xie_xie", "x ie x ie"],
            ["ming_tian_jian", "m ing t ian j ian"]
        ];
        var wordListChinese = {
            "ni_hao": "你好",
            "ni_hao_ma": "你好吗",
