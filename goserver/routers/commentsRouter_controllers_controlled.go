...
func init() {
	...
	beego.GlobalControllerRouter["homecontrol/goserver/controllers/controlled:CommonBuffer"] = append(beego.GlobalControllerRouter["homecontrol/goserver/controllers/controlled:CommonBuffer"],
