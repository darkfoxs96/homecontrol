...
function startup(onMessage) {
    self.onmessage = function(event) {
        ...
        var pocketsphinxJS = (event.data && 'pocketsphinx.js' == event.data) ? event.data['pocketsphinx.js'] : 'pocketsphinx.js';
        var pocketsphinxWASM = (event.data && 'pocketsphinx.wasm' == event.data) ? event.data['pocketsphinx.wasm'] : 'pocketsphinx.wasm';
